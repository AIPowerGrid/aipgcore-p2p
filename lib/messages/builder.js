...
function builder(options) {
  ...
  if (!options.network) {
    options.network = aipgcore.Networks.defaultNetwork;
  }

  options.Block = options.Block || aipgcore.Block;
  options.BlockHeader = options.BlockHeader || aipgcore.BlockHeader;
  options.Transaction = options.Transaction || aipgcore.Transaction;
  options.MerkleBlock = options.MerkleBlock || aipgcore.MerkleBlock;
