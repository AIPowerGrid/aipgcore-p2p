'use strict';
/* eslint-env es6 */
let Pool = require('aipgcore-p2p').Pool;
let BloomFilter = require('aipgcore-p2p').BloomFilter;
let NetworksData = require('aipgcore-lib').Networks;
let Messages = require('aipgcore-p2p').Messages;
...
// Create a filter and a aipgcoin message with the filter
...
// Create a aipgcoin message for require a merkleblock
