 ...
 * using the standard aipgcoin protocol. A Peer instance represents one connection
 * on the aipgcoin network. To create a new peer connection provide the host and port
